...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const emailElement = document.querySelector('.nav__copy_icon');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let menu2 = document.querySelector('.menu-bg');
  menuBtn2.addEventListener('click', function () {
    menu2.classList.toggle('active');
  });
});
document.addEventListener("DOMContentLoaded", () => {
  let menuBtn3 = document.querySelector('.menu__close');
  let menu3 = document.querySelector('.menu');
  let menu4 = document.querySelector('.menu-bg');
  let menu5 = document.querySelector('.menu-btn');
